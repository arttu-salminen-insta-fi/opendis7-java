...
public enum ActionResponseRequestStatus 
{
     ...
     */
    public static ActionResponseRequestStatus getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum ActionResponseRequestStatus");
    }
     ...
     * @return enumeration of interest */
    public static ActionResponseRequestStatus unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
