...
public enum ActionRequestActionID 
{
     ...
     */
    public static ActionRequestActionID getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum ActionRequestActionID");
    }
     ...
     * @return enumeration of interest */
    public static ActionRequestActionID unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
