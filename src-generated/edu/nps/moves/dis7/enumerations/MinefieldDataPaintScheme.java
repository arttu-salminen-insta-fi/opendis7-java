...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         MinefieldDataPaintScheme bitset = new MinefieldDataPaintScheme();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling MinefieldDataPaintScheme data.");
      }
      return map;
  }
  ...
  {
      ((MinefieldDataPaintScheme) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((MinefieldDataPaintScheme) map.get("bitset")).getMarshalledSize();
  }
