...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         AirPlatformAppearance bitset = new AirPlatformAppearance();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling AirPlatformAppearance data.");
      }
      return map;
  }
  ...
  {
      ((AirPlatformAppearance) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((AirPlatformAppearance) map.get("bitset")).getMarshalledSize();
  }
