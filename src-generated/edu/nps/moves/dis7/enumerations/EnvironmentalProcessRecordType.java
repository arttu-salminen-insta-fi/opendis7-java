...
public enum EnvironmentalProcessRecordType 
{
     ...
     */
    public static EnvironmentalProcessRecordType getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum EnvironmentalProcessRecordType");
    }
     ...
     * @return enumeration of interest */
    public static EnvironmentalProcessRecordType unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
