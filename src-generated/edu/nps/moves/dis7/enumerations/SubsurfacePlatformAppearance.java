...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         SubsurfacePlatformAppearance bitset = new SubsurfacePlatformAppearance();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling SubsurfacePlatformAppearance data.");
      }
      return map;
  }
  ...
  {
      ((SubsurfacePlatformAppearance) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((SubsurfacePlatformAppearance) map.get("bitset")).getMarshalledSize();
  }
