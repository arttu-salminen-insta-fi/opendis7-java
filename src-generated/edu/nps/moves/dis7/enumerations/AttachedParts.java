...
public enum AttachedParts 
{
     ...
     */
    public static AttachedParts getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum AttachedParts");
    }
     ...
     * @return enumeration of interest */
    public static AttachedParts unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
