...
public enum SignalUserProtocolIdentificationNumber 
{
     ...
     */
    public static SignalUserProtocolIdentificationNumber getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum SignalUserProtocolIdentificationNumber");
    }
     ...
     * @return enumeration of interest */
    public static SignalUserProtocolIdentificationNumber unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
