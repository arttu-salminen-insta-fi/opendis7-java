...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         LandPlatformCapabilities bitset = new LandPlatformCapabilities();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling LandPlatformCapabilities data.");
      }
      return map;
  }
  ...
  {
      ((LandPlatformCapabilities) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((LandPlatformCapabilities) map.get("bitset")).getMarshalledSize();
  }
