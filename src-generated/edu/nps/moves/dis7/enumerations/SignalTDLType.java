...
public enum SignalTDLType 
{
     ...
     */
    public static SignalTDLType getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum SignalTDLType");
    }
