...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         PointObjectAppearanceCrater bitset = new PointObjectAppearanceCrater();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling PointObjectAppearanceCrater data.");
      }
      return map;
  }
  ...
  {
      ((PointObjectAppearanceCrater) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((PointObjectAppearanceCrater) map.get("bitset")).getMarshalledSize();
  }
