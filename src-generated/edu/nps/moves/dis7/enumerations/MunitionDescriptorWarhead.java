...
public enum MunitionDescriptorWarhead 
{
    ...
    /** Glass Beads */
    // autogenerated using string template disenumpart2.txt
    SUPPLEMENTAL_EMISSION_ENTITY_STATE (30, "Glass Beads"),
    // autogenerated using string template disenumfootnotecomment.txt
     ...
     */
    public static MunitionDescriptorWarhead getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum MunitionDescriptorWarhead");
    }
