...
public enum EventReportEventType 
{
     ...
     */
    public static EventReportEventType getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum EventReportEventType");
    }
     ...
     * @return enumeration of interest */
    public static EventReportEventType unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
