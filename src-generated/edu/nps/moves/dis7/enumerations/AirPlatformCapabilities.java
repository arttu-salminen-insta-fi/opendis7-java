...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         AirPlatformCapabilities bitset = new AirPlatformCapabilities();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling AirPlatformCapabilities data.");
      }
      return map;
  }
  ...
  {
      ((AirPlatformCapabilities) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((AirPlatformCapabilities) map.get("bitset")).getMarshalledSize();
  }
