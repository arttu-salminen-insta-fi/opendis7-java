...
*/
  ...
  public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
  {
      ...
      try
      {
         LinearObjectAppearanceWire bitset = new LinearObjectAppearanceWire();
         bitset.unmarshal(byteBuffer);
         map.put("bitset", bitset);
      }
      catch (java.nio.BufferUnderflowException bue)
      {
          System.err.println("*** buffer underflow error while unmarshalling LinearObjectAppearanceWire data.");
      }
      return map;
  }
  ...
  {
      ((LinearObjectAppearanceWire) map.get("bitset")).marshal(byteBuffer);
  }

  public static int getMarshalledSize(PduMap map)
  {
      return ((LinearObjectAppearanceWire) map.get("bitset")).getMarshalledSize();
  }
