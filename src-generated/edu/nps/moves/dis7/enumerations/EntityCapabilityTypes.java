...
public enum EntityCapabilityTypes 
{
     ...
     */
    public static EntityCapabilityTypes getEnumForValue(int value) throws EnumNotFoundException
    {
       ...
       throw new EnumNotFoundException("No corresponding enumeration found for value " + value + " of enum EntityCapabilityTypes");
    }
     ...
     * @return enumeration of interest */
    public static EntityCapabilityTypes unmarshalEnum (ByteBuffer byteBuffer) throws Exception
    {
