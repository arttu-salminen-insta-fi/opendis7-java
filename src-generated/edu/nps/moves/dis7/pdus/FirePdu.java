 ...
 */
public class FirePdu extends WarfareFamilyPdu implements Serializable, Marshaller
{
   ...
   Value space: uint32 */
   protected UnsignedInteger fireMissionIndex = UnsignedInteger.ZERO;
...
/** Setter for {@link FirePdu#fireMissionIndex}
  * @param pFireMissionIndex new value of interest. Value space uint32
  * @return same object to permit progressive setters */
public synchronized FirePdu setFireMissionIndex(UnsignedInteger pFireMissionIndex)
{
...
/** Getter for {@link FirePdu#fireMissionIndex}
  * @return value of interest */
public UnsignedInteger getFireMissionIndex()
{
...
/** Setter for {@link FirePdu#descriptor}
  ...
  * @return same object to permit progressive setters */
public synchronized FirePdu setDescriptor(Descriptor pDescriptor)
{
...
/** Setter for {@link FirePdu#range}
  * @param pRange new value of interest. Value space float32
  * @return same object to permit progressive setters */
...
public synchronized void marshal(DataOutputStream dos) throws Exception
{
...

    {
       ...
       eventID.marshal(dos);
       dos.writeInt(fireMissionIndex.intValue());
...
public synchronized void marshal(java.nio.ByteBuffer byteBuffer) throws Exception
{
   ...
   byteBuffer.putInt(fireMissionIndex.intValue());
...
public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    map.put("munitionExpendibleID", EntityID.fromBufferToMap(byteBuffer));
    map.put("eventID", EventIdentifier.fromBufferToMap(byteBuffer));
    map.put("fireMissionIndex", UnsignedInteger.fromIntBits(byteBuffer.getInt()));
    ...
    map.put("range", (float) byteBuffer.getFloat());
    return map;
}
...
public static void fromMapToBuffer(PduMap map, java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    EntityID.fromMapToBuffer((PduMap) map.get("munitionExpendibleID"), byteBuffer);
    EventIdentifier.fromMapToBuffer((PduMap) map.get("eventID"), byteBuffer);
    byteBuffer.putInt(((Number) map.get("fireMissionIndex")).intValue());
    ...
    byteBuffer.putFloat(((Number) map.get("range")).floatValue());
}
...
public static int getMarshalledSize(PduMap map) throws Exception
{
    ...
    marshalSize += EntityID.getMarshalledSize((PduMap) map.get("munitionExpendibleID"));
