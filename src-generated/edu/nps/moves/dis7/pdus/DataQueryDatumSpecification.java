 ...
 */
public class DataQueryDatumSpecification extends Object implements Serializable, Marshaller
{
...
public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    {
        fixedDatumIDList.add(UnsignedDISInteger.fromBufferToMap(byteBuffer));
    }
    ...
    {
        variableDatumIDList.add(UnsignedDISInteger.fromBufferToMap(byteBuffer));
    }
...
public static void fromMapToBuffer(PduMap map, java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    for (int idx = 0; idx < ((Number) map.get("numberOfFixedDatums")).intValue(); idx++)
    {
        UnsignedDISInteger.fromMapToBuffer((PduMap) fixedDatumIDList.get(idx), byteBuffer);
    }
    ...
    for (int idx = 0; idx < ((Number) map.get("numberOfVariableDatums")).intValue(); idx++)
    {
        UnsignedDISInteger.fromMapToBuffer((PduMap) variableDatumIDList.get(idx), byteBuffer);
    }
...
public static int getMarshalledSize(PduMap map) throws Exception
{
    ...
    List fixedDatumIDList = (List) map.get("fixedDatumIDList");
    for (int idx = 0; idx < ((Number) map.get("numberOfFixedDatums")).intValue(); idx++)
        marshalSize += UnsignedDISInteger.getMarshalledSize((PduMap) fixedDatumIDList.get(idx));
    List variableDatumIDList = (List) map.get("variableDatumIDList");
    for (int idx = 0; idx < ((Number) map.get("numberOfVariableDatums")).intValue(); idx++)
        marshalSize += UnsignedDISInteger.getMarshalledSize((PduMap) variableDatumIDList.get(idx));
