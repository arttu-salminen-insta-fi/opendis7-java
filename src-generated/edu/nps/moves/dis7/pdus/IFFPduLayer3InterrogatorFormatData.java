 ...
 */
public class IFFPduLayer3InterrogatorFormatData extends AbstractIFFPduLayerData implements Serializable, Marshaller
{
   /** Layer header */
...
/** Setter for {@link IFFPduLayer3InterrogatorFormatData#IFFFundamentalParameterDataRecord}
  ...
  * @return same object to permit progressive setters */
public synchronized IFFPduLayer3InterrogatorFormatData setIFFFundamentalParameterDataRecord(IFFDataSpecification pIFFFundamentalParameterDataRecord)
{
...
public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    map.put("mode5InterrogatorBasicData", Mode5InterrogatorBasicData.fromBufferToMap(byteBuffer));
...
public static void fromMapToBuffer(PduMap map, java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    Mode5InterrogatorBasicData.fromMapToBuffer((PduMap) map.get("mode5InterrogatorBasicData"), byteBuffer);
...
public static int getMarshalledSize(PduMap map) throws Exception
{
    ...
    marshalSize += 2;  // siteNumber
    marshalSize += 2;  // applicationNumber
    marshalSize += Mode5InterrogatorBasicData.getMarshalledSize((PduMap) map.get("mode5InterrogatorBasicData"));
    marshalSize += 2;  // padding
