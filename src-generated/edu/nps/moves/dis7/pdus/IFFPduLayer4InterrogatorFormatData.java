 ...
 */
public class IFFPduLayer4InterrogatorFormatData extends AbstractIFFPduLayerData implements Serializable, Marshaller
{
   /** Layer header */
...
/** Setter for {@link IFFPduLayer4InterrogatorFormatData#IFFFundamentalParameterDataRecord}
  ...
  * @return same object to permit progressive setters */
public synchronized IFFPduLayer4InterrogatorFormatData setIFFFundamentalParameterDataRecord(IFFDataSpecification pIFFFundamentalParameterDataRecord)
{
...
public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    map.put("modeSInterrogatorBasicData", ModeSInterrogatorBasicData.fromBufferToMap(byteBuffer));
...
public static void fromMapToBuffer(PduMap map, java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    ModeSInterrogatorBasicData.fromMapToBuffer((PduMap) map.get("modeSInterrogatorBasicData"), byteBuffer);
...
public static int getMarshalledSize(PduMap map) throws Exception
{
    ...
    marshalSize += 2;  // siteNumber
    marshalSize += 2;  // applicationNumber
    marshalSize += ModeSInterrogatorBasicData.getMarshalledSize((PduMap) map.get("modeSInterrogatorBasicData"));
    marshalSize += 2;  // padding
