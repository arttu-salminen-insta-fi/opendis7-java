 ...
 */
public class Attribute extends Object implements Serializable, Marshaller
{
   /** The record type for this attribute. Enumeration 
   Value space: uint32 */
   protected UnsignedInteger recordType = UnsignedInteger.ZERO;
   ...
   /** Current implementation also holds the padding bits after unmarshall: K + P! */
...
public synchronized Attribute setRecordType(UnsignedInteger pRecordType)
{
...
public synchronized void marshal(DataOutputStream dos) throws Exception
{

    {
       ...
       int padOctetsToInclude = Align.padCountTo64Bits(fixedAndVariableDataOctets);
