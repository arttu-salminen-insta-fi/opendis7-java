 ...
 */
public class Association extends Object implements Serializable, Marshaller
{
...
public static PduMap fromBufferToMap(java.nio.ByteBuffer byteBuffer) throws Exception
{
    ...
    map.put("associationType", EntityAssociationAssociationType.unmarshalEnum(byteBuffer).getValue());
    map.put("padding", Byte.toUnsignedInt(byteBuffer.get()));
    map.put("associatedEntityID", EntityIdentifier.fromBufferToMap(byteBuffer));
    map.put("associatedLocation", Vector3Double.fromBufferToMap(byteBuffer));
    return map;
}
...
{
    EntityAssociationAssociationType.getEnumForValue(((Number) map.get("associationType")).intValue()).marshal(byteBuffer);
    byteBuffer.put(((Number) map.get("padding")).byteValue());
    EntityIdentifier.fromMapToBuffer((PduMap) map.get("associatedEntityID"), byteBuffer);
    Vector3Double.fromMapToBuffer((PduMap) map.get("associatedLocation"), byteBuffer);
}
...
public static int getMarshalledSize(PduMap map) throws Exception
{
    ...
    marshalSize += EntityAssociationAssociationType.getEnumForValue(((Number) map.get("associationType")).intValue()).getMarshalledSize();
    marshalSize += 1;  // padding
    marshalSize += EntityIdentifier.getMarshalledSize((PduMap) map.get("associatedEntityID"));
    marshalSize += Vector3Double.getMarshalledSize((PduMap) map.get("associatedLocation"));
